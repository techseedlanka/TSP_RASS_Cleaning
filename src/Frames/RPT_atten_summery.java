...
public class RPT_atten_summery extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(cmb_month, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 60, 130, -1));
        ...
        getContentPane().add(cmb_year, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 60, 90, -1));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 260, 240, 40));

        cmb_defLocation.setEditable(true);
        cmb_defLocation.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        cmb_defLocation.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "=All Location=", "=Express Locations=", "=Target Locations=" }));
        ...
        getContentPane().add(cmb_defLocation, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 130, 280, -1));
        ...
        getContentPane().add(txt_locName, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 160, 380, 23));

        jLabel2.setFont(new java.awt.Font("Georgia", 0, 16)); // NOI18N
        jLabel2.setText("Attendance Report - Location wise");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 280, 40));
        getContentPane().add(jSeparator9, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 320, 400, 10));

        jLabel10.setFont(new java.awt.Font("Georgia", 0, 14)); // NOI18N
        jLabel10.setText("Month/Year :-");
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 50, 100, 40));
        getContentPane().add(jSeparator10, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 40, 400, 10));

        jProgressBar1.setOpaque(true);
        jProgressBar1.setStringPainted(true);
        getContentPane().add(jProgressBar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 210, 380, 20));

        jLabel11.setFont(new java.awt.Font("Georgia", 0, 14)); // NOI18N
        jLabel11.setText("Location :-");
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 120, 70, 40));
        ...
        Thread hilo = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    String LocID = cmb_defLocation.getSelectedItem().toString();
                    ...
                    } else if (cmb_defLocation.getSelectedIndex() == 1) {
                        txt_locName.setText("");
                    ...
                    } else if (cmb_defLocation.getSelectedIndex() == 2) {
                        txt_locName.setText("");
...
//
//                } else if (cmb_loc_type.getSelectedItem().toString().equals("All")) {
...
//    }
    ...
    private void Old_print_HardCoded() {
        Thread hilo = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Statement st1 = DbConnection.getconnection().createStatement();
                    ResultSet rs1 = st1.executeQuery("select * from emp_atten_main where Location='" + cmb_defLocation.getSelectedItem().toString() + "' and Month='" + get_month + "' and Year='" + get_year + "' group by EPFno ");
                    while (rs1.next()) {

                        jProgressBar1.setValue(10);
                        jProgressBar1.setString("Getting Employee Data");

                        EPF = rs1.getString("EPFno");

                        // }
                        Statement st = DbConnection.getconnection().createStatement();
                        ResultSet rs = st.executeQuery(" select * ,SUM(DayShift),SUM(NightShift),SUM(HalfDayShift),SUM(DNShift),SUM(OTShift),SUM(DayTwoShift)  FROM emp_atten_main  where EPFno='" + EPF + "' and Location='" + cmb_defLocation.getSelectedItem().toString() + "' group by Date ");
...
//                                }
                            ...
                            jProgressBar1.setString("Getting Attendance Data");
                            if (Date.equals(d9)) {
...
//                            if (int_month == 2 | int_month == 4 | int_month == 6 | int_month == 9 | int_month == 11) {
//
//                            } else {
                            if (Date.equals(d31)) {
...
//                            }
                            ...
                            Statement st4 = DbConnection.getconnection().createStatement();
                            ResultSet rs4 = st4.executeQuery("select *,SUM(DayShift),SUM(NightShift),SUM(HalfDayShift),SUM(DNShift),SUM(DayTwoShift),SUM(OTShift),SUM(OTHours) from emp_atten_main where EPFno='" + EPF + "' and Location='" + cmb_defLocation.getSelectedItem().toString() + "' and Month='" + cmb_month.getSelectedItem().toString() + "' and Year='" + cmb_year.getSelectedItem().toString() + "' ");
                            while (rs4.next()) {

                                jProgressBar1.setValue(50);
                                jProgressBar1.setString("Getting Attendance Summery  Details");
                        ...
                        //LocName = rs.getString("LocName");
                        jProgressBar1.setValue(70);
                        jProgressBar1.setString("Generating Report");

                        bds.setL_code(cmb_defLocation.getSelectedItem().toString());
                        bds.setL_name(txt_locName.getText());
                        bds.setCom_name(ComName);
                        bds.setMonth(cmb_month.getSelectedItem().toString());
                        bds.setYear(cmb_year.getSelectedItem().toString());
                        bds.setEmpid(EPF);
                        ...
                        if (d1d.equals("") | d1d == null) {
                            d1d = "0";
                        }

                        if (d1n.equals("") | d1n == null) {
                            d1n = "0";
                        }
                        if (d1h.equals("") | d1h == null) {
                            d1h = "0";
                        }
                        if (d1dn.equals("") | d1dn == null) {
                            d1dn = "0";
                        }
                        if (d1ot.equals("") | d1ot == null) {
                            d1ot = "0";
                        }
                        if (d1othr.equals("") | d1othr == null) {
                            d1othr = "0";
                        }

                        if (d2d.equals("") | d2d == null) {
                            d2d = "0";
                        }
                        if (d2n.equals("") | d2n == null) {
                            d2n = "0";
                        }
                        if (d2h.equals("") | d2h == null) {
                            d2h = "0";
                        }
                        if (d2dn.equals("") | d2dn == null) {
                            d2dn = "0";
                        }
                        if (d2ot.equals("") | d2ot == null) {
                            d2ot = "0";
                        }
                        if (d2othr.equals("") | d2othr == null) {
                            d2othr = "0";
                        }

                        if (d3d.equals("") | d3d == null) {
                            d3d = "0";
                        }
                        if (d3n.equals("") | d3n == null) {
                            d3n = "0";
                        }
                        if (d3h.equals("") | d3h == null) {
                            d3h = "0";
                        }
                        if (d3dn.equals("") | d3dn == null) {
                            d3dn = "0";
                        }
                        if (d3ot.equals("") | d3ot == null) {
                            d3ot = "0";
                        }
                        if (d3othr.equals("") | d3othr == null) {
                            d3othr = "0";
                        }

                        if (d4d.equals("") | d4d == null) {
                            d4d = "0";
                        }
                        if (d4n.equals("") | d4n == null) {
                            d4n = "0";
                        }
                        if (d4h.equals("") | d4h == null) {
                            d4h = "0";
                        }
                        if (d4dn.equals("") | d4dn == null) {
                            d4dn = "0";
                        }
                        if (d4ot.equals("") | d4ot == null) {
                            d4ot = "0";
                        }
                        if (d4othr.equals("") | d4othr == null) {
                            d4othr = "0";
                        }

                        if (d5d.equals("") | d5d == null) {
                            d5d = "0";
                        }
                        if (d5n.equals("") | d5n == null) {
                            d5n = "0";
                        }
                        if (d5h.equals("") | d5h == null) {
                            d5h = "0";
                        }
                        if (d5dn.equals("") | d5dn == null) {
                            d5dn = "0";
                        }
                        if (d5ot.equals("") | d5ot == null) {
                            d5ot = "0";
                        }
                        if (d5othr.equals("") | d5othr == null) {
                            d5othr = "0";
                        }

                        if (d6d.equals("") | d6d == null) {
                            d6d = "0";
                        }
                        if (d6n.equals("") | d6n == null) {
                            d6n = "0";
                        }
                        if (d6h.equals("") | d6h == null) {
                            d6h = "0";
                        }
                        if (d6dn.equals("") | d6dn == null) {
                            d6dn = "0";
                        }
                        if (d6ot.equals("") | d6ot == null) {
                            d6ot = "0";
                        }
                        if (d6othr.equals("") | d6othr == null) {
                            d6othr = "0";
                        }

                        if (d7d.equals("") | d7d == null) {
                            d7d = "0";
                        }
                        if (d7n.equals("") | d7n == null) {
                            d7n = "0";
                        }
                        if (d7h.equals("") | d7h == null) {
                            d7h = "0";
                        }
                        if (d7dn.equals("") | d7dn == null) {
                            d7dn = "0";
                        }
                        if (d7ot.equals("") | d7ot == null) {
                            d7ot = "0";
                        }
                        if (d7othr.equals("") | d7othr == null) {
                            d7othr = "0";
                        }

                        if (d8d.equals("") | d8d == null) {
                            d8d = "0";
                        }
                        if (d8n.equals("") | d8n == null) {
                            d8n = "0";
                        }
                        if (d8h.equals("") | d8h == null) {
                            d8h = "0";
                        }
                        if (d8dn.equals("") | d8dn == null) {
                            d8dn = "0";
                        }
                        if (d8ot.equals("") | d8ot == null) {
                            d8ot = "0";
                        }
                        if (d8othr.equals("") | d8othr == null) {
                            d8othr = "0";
                        }

                        if (d9d.equals("") | d9d == null) {
                            d9d = "0";
                        }
                        if (d9n.equals("") | d9n == null) {
                            d9n = "0";
                        }
                        if (d9h.equals("") | d9h == null) {
                            d9h = "0";
                        }
                        if (d9dn.equals("") | d9dn == null) {
                            d9dn = "0";
                        }
                        if (d9ot.equals("") | d9ot == null) {
                            d9ot = "0";
                        }
                        if (d9othr.equals("") | d9othr == null) {
                            d9othr = "0";
                        }

                        if (d10d.equals("") | d10d == null) {
                            d10d = "0";
                        }
                        if (d10n.equals("") | d10n == null) {
                            d10n = "0";
                        }
                        if (d10h.equals("") | d10h == null) {
                            d10h = "0";
                        }
                        if (d10dn.equals("") | d10dn == null) {
                            d10dn = "0";
                        }
                        if (d10ot.equals("") | d10ot == null) {
                            d10ot = "0";
                        }
                        if (d10othr.equals("") | d10othr == null) {
                            d10othr = "0";
                        }

                        if (d11d.equals("") | d11d == null) {
                            d11d = "0";
                        }
                        if (d11n.equals("") | d11n == null) {
                            d11n = "0";
                        }
                        if (d11h.equals("") | d11h == null) {
                            d11h = "0";
                        }
                        if (d11dn.equals("") | d11dn == null) {
                            d11dn = "0";
                        }
                        if (d11ot.equals("") | d11ot == null) {
                            d11ot = "0";
                        }
                        if (d11othr.equals("") | d11othr == null) {
                            d11othr = "0";
                        }

                        if (d12d.equals("") | d12d == null) {
                            d12d = "0";
                        }
                        if (d12n.equals("") | d12n == null) {
                            d12n = "0";
                        }
                        if (d12h.equals("") | d12h == null) {
                            d12h = "0";
                        }
                        if (d12dn.equals("") | d12dn == null) {
                            d12dn = "0";
                        }
                        if (d12ot.equals("") | d12ot == null) {
                            d12ot = "0";
                        }
                        if (d12othr.equals("") | d12othr == null) {
                            d12othr = "0";
                        }

                        if (d13d.equals("") | d13d == null) {
                            d13d = "0";
                        }
                        if (d13n.equals("") | d13n == null) {
                            d13n = "0";
                        }
                        if (d13h.equals("") | d13h == null) {
                            d13h = "0";
                        }
                        if (d13dn.equals("") | d13dn == null) {
                            d13dn = "0";
                        }
                        if (d13ot.equals("") | d13ot == null) {
                            d13ot = "0";
                        }
                        if (d13othr.equals("") | d13othr == null) {
                            d13othr = "0";
                        }

                        if (d14d.equals("") | d14d == null) {
                            d14d = "0";
                        }
                        if (d14n.equals("") | d14n == null) {
                            d14n = "0";
                        }
                        if (d14h.equals("") | d14h == null) {
                            d14h = "0";
                        }
                        if (d14dn.equals("") | d14dn == null) {
                            d14dn = "0";
                        }
                        if (d14ot.equals("") | d14ot == null) {
                            d14ot = "0";
                        }
                        if (d14othr.equals("") | d14othr == null) {
                            d14othr = "0";
                        }

                        if (d15d.equals("") | d15d == null) {
                            d15d = "0";
                        }
                        if (d15n.equals("") | d15n == null) {
                            d15n = "0";
                        }
                        if (d15h.equals("") | d15h == null) {
                            d15h = "0";
                        }
                        if (d15dn.equals("") | d15dn == null) {
                            d15dn = "0";
                        }
                        if (d15ot.equals("") | d15ot == null) {
                            d15ot = "0";
                        }
                        if (d15othr.equals("") | d15othr == null) {
                            d15othr = "0";
                        }

                        if (d16d.equals("") | d16d == null) {
                            d16d = "0.0";
                        }
                        if (d16n.equals("") | d16n == null) {
                            d16n = "0.0";
                        }
                        if (d16h.equals("") | d16h == null) {
                            d16h = "0.0";
                        }
                        if (d16dn.equals("") | d16dn == null) {
                            d16dn = "0.0";
                        }
                        if (d16ot.equals("") | d16ot == null) {
                            d16ot = "0.0";
                        }
                        if (d16othr.equals("") | d16othr == null) {
                            d16othr = "0.0";
                        }

                        if (d17d.equals("") | d17d == null) {
                            d17d = "0";
                        }
                        if (d17n.equals("") | d17n == null) {
                            d17n = "0";
                        }
                        if (d17h.equals("") | d17h == null) {
                            d17h = "0";
                        }
                        if (d17dn.equals("") | d17dn == null) {
                            d17dn = "0";
                        }
                        if (d17ot.equals("") | d17ot == null) {
                            d17ot = "0";
                        }
                        if (d17othr.equals("") | d17othr == null) {
                            d17othr = "0";
                        }

                        if (d18d.equals("") | d18d == null) {
                            d18d = "0";
                        }
                        if (d18n.equals("") | d18n == null) {
                            d18n = "0";
                        }
                        if (d18h.equals("") | d18h == null) {
                            d18h = "0";
                        }
                        if (d18dn.equals("") | d18dn == null) {
                            d18dn = "0";
                        }
                        if (d18ot.equals("") | d18ot == null) {
                            d18ot = "0";
                        }
                        if (d18othr.equals("") | d18othr == null) {
                            d18othr = "0";
                        }

                        if (d19d.equals("") | d19d == null) {
                            d19d = "0";
                        }
                        if (d19n.equals("") | d19n == null) {
                            d19n = "0";
                        }
                        if (d19h.equals("") | d19h == null) {
                            d19h = "0";
                        }
                        if (d19dn.equals("") | d19dn == null) {
                            d19dn = "0";
                        }
                        if (d19ot.equals("") | d19ot == null) {
                            d19ot = "0";
                        }
                        if (d19othr.equals("") | d19othr == null) {
                            d19othr = "0";
                        }

                        if (d20d.equals("") | d20d == null) {
                            d20d = "0";
                        }
                        if (d20n.equals("") | d20n == null) {
                            d20n = "0";
                        }
                        if (d20h.equals("") | d20h == null) {
                            d20h = "0";
                        }
                        if (d20dn.equals("") | d20dn == null) {
                            d20dn = "0";
                        }
                        if (d20ot.equals("") | d20ot == null) {
                            d20ot = "0";
                        }
                        if (d20othr.equals("") | d20othr == null) {
                            d20othr = "0";
                        }

                        if (d21d.equals("") | d21d == null) {
                            d21d = "0";
                        }
                        if (d21n.equals("") | d21n == null) {
                            d21n = "0";
                        }
                        if (d21h.equals("") | d21h == null) {
                            d21h = "0";
                        }
                        if (d21dn.equals("") | d21dn == null) {
                            d21dn = "0";
                        }
                        if (d21ot.equals("") | d21ot == null) {
                            d21ot = "0";
                        }
                        if (d21othr.equals("") | d21othr == null) {
                            d21othr = "0";
                        }

                        if (d22d.equals("") | d22d == null) {
                            d22d = "0";
                        }
                        if (d22n.equals("") | d22n == null) {
                            d22n = "0";
                        }
                        if (d22h.equals("") | d22h == null) {
                            d22h = "0";
                        }
                        if (d22dn.equals("") | d22dn == null) {
                            d22dn = "0";
                        }
                        if (d22ot.equals("") | d22ot == null) {
                            d22ot = "0";
                        }
                        if (d22othr.equals("") | d22othr == null) {
                            d22othr = "0";
                        }

                        if (d23d.equals("") | d23d == null) {
                            d23d = "0";
                        }
                        if (d23n.equals("") | d23n == null) {
                            d23n = "0";
                        }
                        if (d23h.equals("") | d23h == null) {
                            d23h = "0";
                        }
                        if (d23dn.equals("") | d23dn == null) {
                            d23dn = "0";
                        }
                        if (d23ot.equals("") | d23ot == null) {
                            d23ot = "0";
                        }
                        if (d23othr.equals("") | d23othr == null) {
                            d23othr = "0";
                        }

                        if (d24d.equals("") | d24d == null) {
                            d24d = "0";
                        }
                        if (d24n.equals("") | d24n == null) {
                            d24n = "0";
                        }
                        if (d24h.equals("") | d24h == null) {
                            d24h = "0";
                        }
                        if (d24dn.equals("") | d24dn == null) {
                            d24dn = "0";
                        }
                        if (d24ot.equals("") | d24ot == null) {
                            d24ot = "0";
                        }
                        if (d24othr.equals("") | d24othr == null) {
                            d24othr = "0";
                        }

                        if (d25d.equals("") | d25d == null) {
                            d25d = "0";
                        }
                        if (d25n.equals("") | d25n == null) {
                            d25n = "0";
                        }
                        if (d25h.equals("") | d25h == null) {
                            d25h = "0";
                        }
                        if (d25dn.equals("") | d25dn == null) {
                            d25dn = "0";
                        }
                        if (d25ot.equals("") | d25ot == null) {
                            d25ot = "0";
                        }
                        if (d25othr.equals("") | d25othr == null) {
                            d25othr = "0";
                        }

                        if (d26d.equals("") | d26d == null) {
                            d26d = "0";
                        }
                        if (d26n.equals("") | d26n == null) {
                            d26n = "0";
                        }
                        if (d26h.equals("") | d26h == null) {
                            d26h = "0";
                        }
                        if (d26dn.equals("") | d26dn == null) {
                            d26dn = "0";
                        }
                        if (d26ot.equals("") | d26ot == null) {
                            d26ot = "0";
                        }
                        if (d26othr.equals("") | d26othr == null) {
                            d26othr = "0";
                        }

                        if (d27d.equals("") | d27d == null) {
                            d27d = "0";
                        }
                        if (d27n.equals("") | d27n == null) {
                            d27n = "0";
                        }
                        if (d27h.equals("") | d27h == null) {
                            d27h = "0";
                        }
                        if (d27dn.equals("") | d27dn == null) {
                            d27dn = "0";
                        }
                        if (d27ot.equals("") | d27ot == null) {
                            d27ot = "0";
                        }
                        if (d27othr.equals("") | d27othr == null) {
                            d27othr = "0";
                        }

                        if (d28d.equals("") | d28d == null) {
                            d28d = "0";
                        }
                        if (d28n.equals("") | d28n == null) {
                            d28n = "0";
                        }
                        if (d28h.equals("") | d28h == null) {
                            d28h = "0";
                        }
                        if (d28dn.equals("") | d28dn == null) {
                            d28dn = "0";
                        }
                        if (d28ot.equals("") | d28ot == null) {
                            d28ot = "0";
                        }
                        if (d28othr.equals("") | d28othr == null) {
                            d28othr = "0";
                        }

                        if (d29d.equals("") | d29d == null) {
                            d29d = "0";
                        }
                        if (d29n.equals("") | d29n == null) {
                            d29n = "0";
                        }
                        if (d29h.equals("") | d29h == null) {
                            d29h = "0";
                        }
                        if (d29dn.equals("") | d29dn == null) {
                            d29dn = "0";
                        }
                        if (d29ot.equals("") | d29ot == null) {
                            d29ot = "0";
                        }
                        if (d29othr.equals("") | d29othr == null) {
                            d29othr = "0";
                        }

                        if (d30d.equals("") | d30d == null) {
                            d30d = "0";
                        }
                        if (d30n.equals("") | d30n == null) {
                            d30n = "0";
                        }
                        if (d30h.equals("") | d30h == null) {
                            d30h = "0";
                        }
                        if (d30dn.equals("") | d30dn == null) {
                            d30dn = "0";
                        }
                        if (d30ot.equals("") | d30ot == null) {
                            d30ot = "0";
                        }
                        if (d30othr.equals("") | d30othr == null) {
                            d30othr = "0";
                        }

                        if (d31d.equals("") | d31d == null) {
                            d31d = "0";
                        }
                        if (d31n.equals("") | d31n == null) {
                            d31n = "0";
                        }
                        if (d31h.equals("") | d31h == null) {
                            d31h = "0";
                        }
                        if (d31dn.equals("") | d31dn == null) {
                            d31dn = "0";
                        }
                        if (d31ot.equals("") | d31ot == null) {
                            d31ot = "0";
                        }
                        if (d31othr.equals("") | d31othr == null) {
                            d31othr = "0";
                        }

                        if (d1dt.equals("") | d1dt == null) {
                            d1dt = "0";
                        }
                        if (d2dt.equals("") | d2dt == null) {
                            d2dt = "0";
                        }
                        if (d3dt.equals("") | d3dt == null) {
                            d3dt = "0";
                        }
                        if (d4dt.equals("") | d4dt == null) {
                            d4dt = "0";
                        }
                        if (d5dt.equals("") | d5dt == null) {
                            d5dt = "0";
                        }
                        if (d6dt.equals("") | d6dt == null) {
                            d6dt = "0";
                        }
                        if (d7dt.equals("") | d7dt == null) {
                            d7dt = "0";
                        }
                        if (d8dt.equals("") | d8dt == null) {
                            d8dt = "0";
                        }
                        if (d9dt.equals("") | d9dt == null) {
                            d9dt = "0";
                        }
                        if (d10dt.equals("") | d10dt == null) {
                            d10dt = "0";
                        }
                        if (d11dt.equals("") | d11dt == null) {
                            d11dt = "0";
                        }
                        if (d12dt.equals("") | d12dt == null) {
                            d12dt = "0";
                        }
                        if (d13dt.equals("") | d13dt == null) {
                            d13dt = "0";
                        }
                        if (d14dt.equals("") | d14dt == null) {
                            d14dt = "0";
                        }
                        if (d15dt.equals("") | d15dt == null) {
                            d15dt = "0";
                        }
                        if (d16dt.equals("") | d16dt == null) {
                            d16dt = "0";
                        }
                        if (d17dt.equals("") | d17dt == null) {
                            d17dt = "0";
                        }
                        if (d18dt.equals("") | d18dt == null) {
                            d18dt = "0";
                        }
                        if (d19dt.equals("") | d19dt == null) {
                            d19dt = "0";
                        }
                        if (d20dt.equals("") | d20dt == null) {
                            d20dt = "0";
                        }
                        if (d21dt.equals("") | d21dt == null) {
                            d21dt = "0";
                        }
                        if (d22dt.equals("") | d22dt == null) {
                            d22dt = "0";
                        }
                        if (d23dt.equals("") | d23dt == null) {
                            d23dt = "0";
                        }
                        if (d24dt.equals("") | d24dt == null) {
                            d24dt = "0";
                        }
                        if (d25dt.equals("") | d25dt == null) {
                            d25dt = "0";
                        }
                        if (d26dt.equals("") | d26dt == null) {
                            d26dt = "0";
                        }
                        if (d27dt.equals("") | d27dt == null) {
                            d27dt = "0";
                        }
                        if (d28dt.equals("") | d28dt == null) {
                            d28dt = "0";
                        }
                        if (d29dt.equals("") | d29dt == null) {
                            d29dt = "0";
                        }
                        if (d30dt.equals("") | d30dt == null) {
                            d30dt = "0";
                        }
                        if (d31dt.equals("") | d31dt == null) {
                            d31dt = "0";
                        }
                    ...
                    jProgressBar1.setValue(80);
                    jProgressBar1.setString("Report Printing");
