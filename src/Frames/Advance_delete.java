 ...
 * @author Sapu
 */
public class Advance_delete extends javax.swing.JFrame {

    /**
     * Creates new form Advance_delete
     */
    public Advance_delete() {
        initComponents();
    ...
    private void get_advance_details() {
        ...
        if (jCheckBox1.isSelected()) {
            ...
            sql = "select * from salary_advance_1 where PayMonth ='" + cmb_month.getSelectedItem().toString() + "' and PayYear= '" + cmb_year.getSelectedItem().toString() + "' and Status!='MonthEnd' ";
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    v.add(rs.getString("PayMonth"));
                    v.add(rs.getString("PayYear"));
            ...
            if (cmb_defLocation.getSelectedItem().toString().equals("=Location=")) {
                ...
                sql = "select * from salary_advance_1 where PayMonth ='" + cmb_month.getSelectedItem().toString() + "' and PayYear= '" + cmb_year.getSelectedItem().toString() + "' and Location='" + txt_locCode.getText() + "' ";
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Employee Advance Delete");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 210, 40));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "EMP No.", "Rank", "Name", "Amount", "Location", "Pay Month", "Pay Year", "Reference"
            }
        ) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (nrow == 0) {
            ...
            int reply = JOptionPane.showConfirmDialog(rootPane, " Do you want to Delete the selected Advance of this Employee?", "Advance Delete", JOptionPane.YES_NO_OPTION);
...
//delete query begins*************************************************************************************************
                                    ...
                                    Statement st = DbConnection.getconnection().createStatement();
                                    st.executeUpdate("delete from salary_advance_1 where Reference = '" + reference + "'");
...
//                                    st.executeUpdate("delete from salary_advance_festival where EPFno = '" + txt_empid.getText() + "' and IssueDate = '" + Date + "' and Amount = '" + amount + "' and Note = '" + note + "' and Reference = '" + reference + "'");
                                    ...
                                    JOptionPane.showMessageDialog(rootPane, " Advance Deleted... ");
                                    //delete query ends ****************************************************************************************************
                                } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Advance_delete.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Advance_delete().setVisible(true);
            }
        });
    }
