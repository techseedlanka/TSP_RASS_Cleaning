 ...
 * @author Sapu
 */
public class Shoe_Issue_DELETE extends javax.swing.JFrame {

    /**
     * Creates new form Shoe_Issue_DELETE
     */
    public Shoe_Issue_DELETE() {
        initComponents();
    }
    ...
    private void get_details() {
        ...
        if (date_from.getDate() == null | date_to.getDate() == null) {
            ...
            try {
                ...
                ResultSet rs = st.executeQuery(" SELECT * FROM shoes_issue WHERE IssueOn BETWEEN '" + from + "' AND '" + to + "' and Status='on-going' ORDER BY EPFno");
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "EPF No.", "Employee Name", "Shoe QTY", "Unit Cost", "Total", "Installments", "Rental", "Issued Date", "Note"
            }
        ) {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 100, 960, 370));
        ...
        jLabel1.setText("Shoes Issue - DELETE");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 240, 40));
        getContentPane().add(jSeparator6, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 530, 960, 10));
        ...
        getContentPane().add(jSeparator7, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 40, 960, 10));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 480, 200, -1));
...
//delete query begins*************************************************************************************************
                                    ...
                                    Statement st = DbConnection.getconnection().createStatement();
                                    st.executeUpdate("delete from shoes_Issue where EPFno = '" + EPFno + "' and IssueOn = '" + IssueDate + "' and Rental = '" + Rental + "' and Installments = '" + Installments + "' ");
                                    st.executeUpdate("delete from shoe_issue_settlement where EPFno = '" + EPFno + "' and Reference = '" + Ref + "' ");
                                    ...
                                    JOptionPane.showMessageDialog(rootPane, " Issued Shoes Details were Deleted... ");
                                    //delete query ends ****************************************************************************************************
                                } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Shoe_Issue_DELETE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Shoe_Issue_DELETE().setVisible(true);
            }
        });
    }
