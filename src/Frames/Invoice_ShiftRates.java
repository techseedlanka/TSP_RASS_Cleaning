...
public class Invoice_ShiftRates extends javax.swing.JFrame {

    /**
     *
     */
    public Invoice_ShiftRates() {
        initComponents();
        get_Location_Details();

        jButton4.setText("<html>All Locations<br> Shift Rates</html>");
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Invoice  Shift Rates - Location Wise");
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 160, 110, -1));
        ...
        jButton4.setText("All Loc: Shift Rates");
        jButton4.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton4ActionPerformed(evt);
            }
        });
        getContentPane().add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 310, 110, 70));
        ...
        getContentPane().add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 260, 110, -1));
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        if (txt_amt.getText().isEmpty() | txt_locName.getText().isEmpty()) {
            ...
            t.Invoice_Shift_Rank = cmb_EffectiveRank.getSelectedItem().toString();
            t.Invoice_Shift_Loc = cmb_defLocation.getSelectedItem().toString();
            t.Invoice_Shift_Rate = txt_amt.getText();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (nrow == 0) {
            ...
            try {
                ...
                Statement st = DbConnection.getconnection().createStatement();
                for (table_data t : al) {
                    st.executeUpdate("insert into invoice_shift_rates values ('" + t.Invoice_Shift_Loc + "','" + t.Invoice_Shift_Rank + "','" + t.Invoice_Shift_Rate + "')");
                }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (nrow == 0) {
            ...
            try {
                ...
                Statement st = DbConnection.getconnection().createStatement();
                st.executeUpdate("delete from invoice_shift_rates where InvoShiftLoc = '" + loc + "' and InvoShiftRank ='" + rank + "' and InvoShiftRate = '" + amount + "'  ");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        RPT_All_Location_Invoice_ShiftRates ap = new RPT_All_Location_Invoice_ShiftRates();
        ap.setVisible(true);
    ...
    private void cmb_defLocationPopupMenuWillBecomeInvisible(javax.swing.event.PopupMenuEvent evt) {//GEN-FIRST:event_cmb_defLocationPopupMenuWillBecomeInvisible
        ...
        if (cmb_defLocation.getSelectedItem().equals("=Location=")) {
            ...
            try {
                ...
                DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
                // dtm.setRowCount(0);
                ResultSet rs2 = st.executeQuery("select * from invoice_shift_rates where InvoShiftLoc= '" + cmb_defLocation.getSelectedItem().toString() + "' ");

                while (rs2.next()) {

                    String rank = rs2.getString("InvoShiftRank");
                    String amount = rs2.getString("InvoShiftRate");
                    String loc = rs2.getString("InvoShiftLoc");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Invoice_ShiftRates.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Invoice_ShiftRates().setVisible(true);
            }
        });
    }
