 ...
 * @author Sapu
 */
public class Salary_process extends javax.swing.JFrame {

    /**
     * Creates new form Salary_process
     */
    public Salary_process() {
        initComponents();
        Date d = new Date();
    ...
    private void SSS_EMP_SALARY_OLD_FORMULA() {
            ...
            try {
                ...
                while (rs_main.next()) {
                    ...
                    while (rs.next()) {
                        ...
                        ResultSet rs3 = st3.executeQuery("select * , COUNT(*),SUM(TotalAmount) from  emp_atten_rate_change_shift_summery where EPFno='" + EpfNo + "' and Month= '" + cmb_month.getSelectedItem().toString() + "' and Year= '" + cmb_year.getSelectedItem().toString() + "' ");
                        while (rs3.next()) {
...
//Salary NEW FORMULA
    ...
    private void initComponents() {
        ...
        btn_SSS_salary_process1 = new javax.swing.JButton();
        ...
        btn_Director_salary_process1 = new javax.swing.JButton();
        jButton6 = new javax.swing.JButton();
        jLabel2 = new javax.swing.JLabel();

        btn_SSS_salary_process1.setFont(new java.awt.Font("Georgia", 0, 16)); // NOI18N
        btn_SSS_salary_process1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/Workflow-48.png"))); // NOI18N
        btn_SSS_salary_process1.setText("SSS Guards");
        btn_SSS_salary_process1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                btn_SSS_salary_process1MousePressed(evt);
            }
        });
        btn_SSS_salary_process1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_SSS_salary_process1ActionPerformed(evt);
            }
        });
        ...
        getContentPane().add(btn_SSS_salary_process, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 190, 190, 50));
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 430, 40));
        getContentPane().add(jSeparator6, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 590, 460, 10));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 550, 430, 40));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 450, 210, -1));
        ...
        getContentPane().add(lbl_atten, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 390, 450, 50));
        ...
        getContentPane().add(btn_Office_salary_process, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 260, 190, 50));
        ...
        getContentPane().add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 500, 200, -1));
        ...
        getContentPane().add(btn_Tempory_salary_process, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 320, 430, 50));
        ...
        getContentPane().add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 500, 210, -1));

        btn_Director_salary_process1.setFont(new java.awt.Font("Georgia", 0, 16)); // NOI18N
        btn_Director_salary_process1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/Workflow-48.png"))); // NOI18N
        btn_Director_salary_process1.setText("Director Staff ");
        btn_Director_salary_process1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                btn_Director_salary_process1MousePressed(evt);
            }
        });
        btn_Director_salary_process1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_Director_salary_process1ActionPerformed(evt);
            }
        });
        getContentPane().add(btn_Director_salary_process1, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 260, 210, 50));
        ...
        jButton6.setText("Director Staff Pay Slips");
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 150, 450, 230));
    ...
    private void btn_SSS_salary_processActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_SSS_salary_processActionPerformed
        ...
        if (MonthEnd == 0) {
            SSS_EMP_SALARY_NEW_FORMULA();
            SSS_EMP_SALARY_OLD_FORMULA();
        } else {
...
// Getting NoPay days / No. of ExtraShifts  and Additional Shifts
                    ...
                    //Get details OF Manual Salary Adjustments- Deductions 
                    Statement manual_st = DbConnection.getconnection().createStatement();
                    ResultSet manual_rs = manual_st.executeQuery("SELECT *,COUNT(*),SUM(Meal),SUM(Rental),SUM(LessShift),SUM(OtherDeduc),SUM(DeathDonation),SUM(Insuarance),SUM(PaidSalary10th),SUM(Fines)  FROM salary_manual_deductions WHERE EPFno = '" + EPF + "' and Month = '" + cmb_month.getSelectedItem().toString() + "' and year = '" + cmb_year.getSelectedItem().toString() + "' ");
                    while (manual_rs.next()) {

                        int count = Integer.parseInt(manual_rs.getString("COUNT(*)"));

                        if (count == 0) {

                        } else {
                            Meal = Double.parseDouble(manual_rs.getString("SUM(Meal)"));
                            Fines = Double.parseDouble(manual_rs.getString("SUM(Fines)"));
                            Rental = Double.parseDouble(manual_rs.getString("SUM(Rental)"));
                            LessShift = Double.parseDouble(manual_rs.getString("SUM(LessShift)"));
                            OtherDeductions = Double.parseDouble(manual_rs.getString("SUM(OtherDeduc)"));
                            PaidSalary = Double.parseDouble(manual_rs.getString("SUM(PaidSalary10th)"));
                            Insuarance = Double.parseDouble(manual_rs.getString("SUM(Insuarance)"));
                            Death = Double.parseDouble(manual_rs.getString("SUM(DeathDonation)"));
...
//*****************END OF OLD CALCULATION******************************************
    ...
    private void btn_Office_salary_processMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_Office_salary_processMousePressed
        ...
        if (MonthEnd == 0) {
            ...
            lbl_atten.setText(" Salary DID NOT PROCESSED....");
            lbl_atten.setForeground(Color.black);
            lbl_atten.setVisible(true);
        }
    ...
    private void btn_Director_salary_process1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_Director_salary_process1MousePressed
        if (MonthEnd == 0) {
            lbl_atten.setText(" Director Salary Processing.... Please Wait...!");
            lbl_atten.setForeground(Color.red);
            lbl_atten.setVisible(true);
        } else {
            lbl_atten.setText(" Salary DID NOT PROCESSED....");
    ...
    }//GEN-LAST:event_btn_Director_salary_process1MousePressed

    private void btn_Director_salary_process1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_Director_salary_process1ActionPerformed
...
//*************** END OF NEW CALCULATION****************************************
    ...
    }//GEN-LAST:event_btn_Director_salary_process1ActionPerformed
    ...
    private void btn_SSS_salary_process1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_SSS_salary_process1MousePressed
        // TODO add your handling code here:
    }//GEN-LAST:event_btn_SSS_salary_process1MousePressed

    private void btn_SSS_salary_process1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_SSS_salary_process1ActionPerformed


    }//GEN-LAST:event_btn_SSS_salary_process1ActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Salary_process.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Salary_process().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton btn_Director_salary_process1;
    ...
    private javax.swing.JButton btn_SSS_salary_process1;
