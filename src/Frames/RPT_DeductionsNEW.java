 ...
 * @author Sapu
 */
public class RPT_DeductionsNEW extends javax.swing.JFrame {
    ...
    private void TitleBar() {
        this.setTitle("Monthly Deductions Reports");
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Monthly Deductions Reports");
        ...
        cmb_deduction_type.setFont(new java.awt.Font("Times New Roman", 0, 15)); // NOI18N
        cmb_deduction_type.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "==SELECT==", "ALL", "Loan 01", "Loan 02", "Uniform", "Festival Advance", "Fines", "Rent", "Death Donation", "Meals", "Other", "Insuarance", "Special Advance" }));
        ...
        getContentPane().add(cmb_deduction_type, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 100, 480, 28));
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (cmb_deduction_type.getSelectedItem().toString().equals("Festival Advance")) {
            ...
            try {
                ...
                if (empType.equals("ALL")) {
                    ...
                    employeeType = employeeType =  empType ;;
                    System.out.println(employeeType);
                }

                String deductiontype = "";
                if (cmb_deduction_type.getSelectedIndex() == 1) {
                    deductiontype = " *";
                } else {
                    deductiontype = cmb_deduction_type.getSelectedItem().toString();
                ...
                hm.put("deductionType", deductiontype);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RPT_DeductionsNEW.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RPT_DeductionsNEW().setVisible(true);
            }
        });
    }
