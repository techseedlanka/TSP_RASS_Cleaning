 ...
 * @author Sapu
 */
public class EMP_Atten_TotalShifts extends javax.swing.JFrame {
    ...
    public EMP_Atten_TotalShifts() {
        ...
        txt_EffectiveShiftRates.setText("0.00");
    ...
    private void add_to_table() {
        ...
        if (left <= 0) {
            ...
            if (txt_Shifts.getText().isEmpty() | (txt_EPFno.getText().isEmpty())) {
                ...
                // v.add(night)
                //v.add(full);
                v.add(txt_Shifts.getText());
                v.add(txt_month.getText());
                v.add(txt_Year.getText());
                v.add(txt_EffectiveShiftRates.getText());
                v.add(txt_TotalAMT.getText());
        ...
        if (cmb_EffectiveRank.getSelectedItem().toString().equals("==Effective Rank==") | cmb_EffectiveRank.getSelectedItem().toString().equals("")) {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    txt_EffectiveShiftRates.setText(rs.getString("ShiftRate"));
            ...
            if (txt_EmployeeNo.getText().isEmpty()) { //!(txt_EmployeeNo.getText().isEmpty()  | txt_EPFno.getText().isEmpty())
                ...
                if ((txt_Shifts.getText().isEmpty() | txt_TotalAMT.getText().isEmpty())) {
                    ...
                    double x = Double.parseDouble(txt_EffectiveShiftRates.getText());
                    ...
                    if (x == y) {
                        ...
                        if (reply == JOptionPane.YES_OPTION) {//==>YES_OPTION== Save Query
                            ...
                            if (reply1 == JOptionPane.OK_OPTION) {
                                txt_EffectiveShiftRates.setText(txt_shiftRate.getText());
                                add_to_table();
...
//
//            } else {
//                if (txt_EffectiveShiftRates.getText().equals(txt_shiftRate.getText())) {
//
//                } else {
//
//                    if (cb_night.isSelected()) {
//                        night = 1;
//                        EffectiveRate = txt_EffectiveShiftRates.getText();
//                    } else {
//                        night = 0;
//                    }
...
//                        half = 1;
//                        Double rate = Double.parseDouble(txt_EffectiveShiftRates.getText());
...
//        }
    ...
    private void get_totalAMT() {

        if (txt_Shifts.getText().isEmpty() | txt_EmployeeNo.getText().isEmpty()) {

        } else {

            Double rate = Double.parseDouble(txt_EffectiveShiftRates.getText());
            Double shift = Double.parseDouble(txt_Shifts.getText());

            Double totalAMT = rate * shift;

            txt_TotalAMT.setText(Double.toString(totalAMT));
    ...
    private void initComponents() {
        ...
        txt_EffectiveShiftRates = new javax.swing.JTextField();
        txt_EmployeeNo = new javax.swing.JTextField();
        jLabel13 = new javax.swing.JLabel();
        txt_Shifts = new javax.swing.JTextField();
        ...
        getContentPane().add(lbl_total_shifts, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 270, 70, 20));
        ...
        getContentPane().add(btn_ADD, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 160, 100, -1));
        ...
        tbl_atten.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "EMP no", "Total Shifts", "Month", "Year", "Rate", "TotalAmt", "COM", "LOC"
            }
        ) {
        ...
        if (tbl_atten.getColumnModel().getColumnCount() > 0) {
            ...
            tbl_atten.getColumnModel().getColumn(6).setPreferredWidth(1);
            tbl_atten.getColumnModel().getColumn(7).setPreferredWidth(1);
        }

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 164, 620, 310));
        ...
        jPanel1.add(txt_name, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 50, 260, 21));
        ...
        jPanel1.add(txt_rank, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 80, 70, 21));
        ...
        jPanel1.add(txt_shiftRate, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 80, 70, 21));

        jLabel11.setFont(new java.awt.Font("Georgia", 0, 12)); // NOI18N
        jLabel11.setText(" NIC No.  :-");
        jPanel1.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 20, -1, 20));

        txt_empNic.setEditable(false);
        txt_empNic.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        jPanel1.add(txt_empNic, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 20, 120, 21));

        EMP_COM.setText("EMP_Company");
        jPanel1.add(EMP_COM, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 80, 80, 20));

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 100, 340, 110));
        ...
        getContentPane().add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 370, 150, 40));
        ...
        getContentPane().add(btn_Save, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 320, 120, 90));
        ...
        getContentPane().add(txt_search, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 130, 220, 25));
        ...
        getContentPane().add(btn_RemoveRow, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 320, 150, 40));
        ...
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 250, 90, 20));
        ...
        getContentPane().add(lbl_shifts_left, new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 270, 90, 20));

        jLabel12.setFont(new java.awt.Font("Georgia", 0, 12)); // NOI18N
        jLabel12.setText("Total Shifts");
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 250, -1, 20));
        ...
        getContentPane().add(btn_extraShifts, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 420, 280, 40));
        ...
        getContentPane().add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(980, 340, 100, 100));
        ...
        getContentPane().add(jScrollPane4, new org.netbeans.lib.awtextra.AbsoluteConstraints(980, 250, 100, 90));
        ...
        getContentPane().add(cmb_EffectiveRank, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 130, 150, 25));

        txt_EffectiveShiftRates.setFont(new java.awt.Font("Times New Roman", 0, 16)); // NOI18N
        txt_EffectiveShiftRates.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                txt_EffectiveShiftRatesFocusLost(evt);
            }
        });
        txt_EffectiveShiftRates.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_EffectiveShiftRatesActionPerformed(evt);
            }
        });
        getContentPane().add(txt_EffectiveShiftRates, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 130, 90, 25));

        txt_EmployeeNo.setEditable(false);
        txt_EmployeeNo.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        getContentPane().add(txt_EmployeeNo, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 130, 60, 25));

        jLabel13.setFont(new java.awt.Font("Georgia", 0, 12)); // NOI18N
        jLabel13.setText("Total Amount");
        getContentPane().add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 110, -1, 20));

        txt_Shifts.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        txt_Shifts.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                txt_ShiftsFocusGained(evt);
            }
        });
        txt_Shifts.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_ShiftsActionPerformed(evt);
            }
        });
        txt_Shifts.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txt_ShiftsKeyPressed(evt);
            }
        });
        getContentPane().add(txt_Shifts, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 130, 90, 25));

        txt_TotalAMT.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        txt_TotalAMT.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                txt_TotalAMTFocusGained(evt);
            }
        });
        txt_TotalAMT.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txt_TotalAMTKeyPressed(evt);
            }
        });
        getContentPane().add(txt_TotalAMT, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 130, 110, 25));

        jLabel14.setFont(new java.awt.Font("Georgia", 0, 12)); // NOI18N
        jLabel14.setText("EMP. No.");
        getContentPane().add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 110, -1, 20));

        jLabel15.setFont(new java.awt.Font("Georgia", 0, 12)); // NOI18N
        jLabel15.setText("Total Shifts");
        getContentPane().add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 110, -1, 20));

        jLabel16.setFont(new java.awt.Font("Georgia", 0, 12)); // NOI18N
        jLabel16.setText("Effective Rank");
        getContentPane().add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 110, -1, 20));

        jLabel17.setFont(new java.awt.Font("Georgia", 0, 12)); // NOI18N
        jLabel17.setText("Shift Rate");
        getContentPane().add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 110, -1, 20));
        ...
        getContentPane().add(lbl_photo, new org.netbeans.lib.awtextra.AbsoluteConstraints(900, 210, 50, 30));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(950, 210, 130, 30));
...
//            }
            ...
            if (cmb_EffectiveRank.getSelectedItem().equals("==Effective Rank==")) {
                ...
                txt_EffectiveShiftRates.setBackground(Color.red);
...
// save attendance details to emp_attn_main table 
            ...
            if (tbl_atten.getRowCount() == 0) {
                ...
                Statement st = DbConnection.getconnection().createStatement();
                for (table_data t : al) {
                    st.executeUpdate("insert into emp_atten_rate_change_shift_summery values('" + t.EmployeeNo + "','" + t.Location + "','" + t.EffectRate + "','" + t.totalAmount + "','" + t.totalShifts + "','" + t.month + "','" + t.year + "','" + t.DefCompany + "', 'pending','salary_pending')");
...
//            }
    ...
    private void cmb_EffectiveRankPopupMenuWillBecomeInvisible(javax.swing.event.PopupMenuEvent evt) {//GEN-FIRST:event_cmb_EffectiveRankPopupMenuWillBecomeInvisible
        ...
        if (cmb_EffectiveRank.getSelectedItem().equals("==Effective Rank==")) {
            ...
            txt_EffectiveShiftRates.setText("0.00");
            txt_EffectiveShiftRates.setBackground(Color.white);
    ...
    private void txt_EffectiveShiftRatesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt_EffectiveShiftRatesActionPerformed
        txt_TotalAMT.grabFocus();        // TODO add your handling code here:
    }//GEN-LAST:event_txt_EffectiveShiftRatesActionPerformed
...
//update query ends ****************************************************************************************************
    ...
    private void txt_ShiftsFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txt_ShiftsFocusGained
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_ShiftsFocusGained

    private void txt_ShiftsKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_ShiftsKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_ShiftsKeyPressed

    private void txt_TotalAMTFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txt_TotalAMTFocusGained
        // get_totalAMT();        // TODO add your handling code here:
    }//GEN-LAST:event_txt_TotalAMTFocusGained

    private void txt_TotalAMTKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_TotalAMTKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            add_buton_action();
        }
    }//GEN-LAST:event_txt_TotalAMTKeyPressed

    private void txt_searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt_searchActionPerformed
        txt_Shifts.grabFocus();        // TODO add your handling code here:
    }//GEN-LAST:event_txt_searchActionPerformed

    private void txt_ShiftsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt_ShiftsActionPerformed
        txt_EffectiveShiftRates.grabFocus();        // TODO add your handling code here:
    }//GEN-LAST:event_txt_ShiftsActionPerformed

    private void txt_EffectiveShiftRatesFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txt_EffectiveShiftRatesFocusLost
        get_totalAMT();        // TODO add your handling code here:
    }//GEN-LAST:event_txt_EffectiveShiftRatesFocusLost
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EMP_Atten_TotalShifts.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EMP_Atten_TotalShifts().setVisible(true);
            }
        });
    }
...
//            tbl_half = 0.0;
//        }
        Double Entered_shifts = Double.parseDouble(txt_Shifts.getText());
        Double left_shifts = Double.parseDouble(lbl_shifts_left.getText());
        Double x = left_shifts - Entered_shifts;
...
//                }
    ...
    private javax.swing.JTextField txt_EffectiveShiftRates;
    private javax.swing.JTextField txt_EmployeeNo;
    private javax.swing.JTextField txt_Shifts;
