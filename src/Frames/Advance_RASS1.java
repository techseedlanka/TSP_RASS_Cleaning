 ...
 */
public class Advance_RASS1 extends javax.swing.JFrame {

    /**
     * Creates new form Advance_RASS
     */
    public Advance_RASS1() {
...
//                }
    ...
    private void jButton14ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton14ActionPerformed
        try {
            ...
            String del = "delete from salary_advance_1 where ReferenceID='" + txt_doc_no.getText() + "' ";
...
//        MAIN.jMenuItem27.setEnabled(false);        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Advance_RASS1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Advance_RASS1().setVisible(true);
            }
        });
    }
    ...
    public void JButtonTableExample() {

        DefaultTableModel dm = (DefaultTableModel) jTable1.getModel();
        //   dm.setDataVector(new Object[][]{{"1"}, {"2"}}, new Object[]{"Buttons"});

        //JTable table = new JTable(dm);
        jTable1.getColumn(4).setCellRenderer(new PanelRenderer());
        jTable1.getColumn(4).setCellEditor(new PanelEditor(new JTextField()));
    ...
    class PanelEditor extends DefaultCellEditor {
        ...
        public Component getTableCellEditorComponent(JTable jTable1, Object value, boolean isSelected, int row, int column) {
            if (isSelected) {
                button1.setForeground(jTable1.getSelectionForeground());
                button1.setBackground(jTable1.getSelectionBackground());
            } else {
                button1.setForeground(jTable1.getForeground());
                button1.setBackground(jTable1.getBackground());
            }
            return panel;
        }
    }
